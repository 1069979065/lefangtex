	...
	$('.cf_active:gt(0) ').children('a').click(function() {
            ...
            $(this).siblings().removeClass('orange');
               ...
               lb_ids=String(lb_ids);
				...
				//商品分页接口
			var page= new MilkT(pro_page ,3)
          page.send({categoryId:'39',currentPage:'1',attributeValues:lb_vlues,attributeIds:lb_ids})
              .done(function(data){
                // console.log(data);
		...
		/********* 默认加载 ****************/
		var page= new MilkT(pro_page ,3)
          page.send({categoryId:'39',currentPage:'1'})
              .done(function(data){
               console.log(data);
