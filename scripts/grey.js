				              ...
				              .done(function(data){
				                ...
				                var li = _.template('<% _.forEach(pro_list, function(data){ \
				                  %><li>\
										...
										<a href="grey_detail.html?id=<%=data.productId%>" class="buy">立即购买</a>\
									</li><%\
				                });%>');
	...
	$('.cf_active:gt(0) ').children('a').click(function() {
            ...
            $(this).siblings().removeClass('orange');
               ...
               lb_ids=String(lb_ids);
				...
				//商品分页接口
			var page= new MilkT(pro_page ,3)
          page.send({categoryId:'48',currentPage:'1',attributeValues:lb_vlues,attributeIds:lb_ids})
              .done(function(data){
                // console.log(data);
		...
		/*************************/
		var page= new MilkT(pro_page ,3)
          page.send({categoryId:'48',currentPage:'1'})
              .done(function(data){
               console.log(data);
